...
@section('content')
    ...
    @include('backend.pages.typeofrawmaterials.modal')
@endsection
    ...
    <script type="text/javascript">
        function initialDatatable(name = null, email = null, phone = null) {
            var table = jQuery('#dataTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.typeofrawmaterials.get.list') }}",
                    type: 'GET',
                    data: {
                        'name': name,
                        'email': email,
        ...
        $(document).on('click', '#submitCreateForm', function(e) {
            ...
            if (go_next_step == true) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.typeofrawmaterials.store') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
        ...
        $(document).on('click', '.edit_btn', function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.typeofrawmaterials.edit') }}",
                type: "GET",
                data: {
                    id: id
                },
        ...
        $(document).on('click', '#submitEditForm', function(e) {
            ...
            if (go_next_step == true) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.typeofrawmaterials.update') }}",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
        ...
        $(document).on('click', '.delete_btn', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.typeofrawmaterials.delete') }}",
                        type: "GET",
                        data: {
                            id: id
                        },
