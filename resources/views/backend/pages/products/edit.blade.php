<form id="editForm" method="post">
    ...
    <div class="modal-body">
        ...
        <div class="form-group  row">
            ...
            <div class="col-sm-9">
                <input type="text" name="quantity" value="{{ $product->quantity }}" class="form-control" placeholder="Quantity" required>
            </div>
        </div>
        <div class="form-group  row">
            <label for="" class="col-sm-3 col-form-label">Date</label>
            <div class="col-sm-9">
                <input type="text" name="date" value="{{ $product->date }}" class="form-control datepicker" placeholder="Date" required>
            </div>
        </div>
    </div>
