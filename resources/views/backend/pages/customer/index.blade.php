...
@section('title', 'Customer | ' . Helper::getSettings('application_name') ?? 'ERP')
@section('content')
    <div class="container-fluid px-4">
        <h4 class="mt-2">Customer Management</h4>
        <div class="card my-2">
            <div class="card-header">
                <div class="row ">
                    <div class="col-12 d-flex justify-content-between">
                        <div class="d-flex align-items-center">
                            <h5 class="m-0">Cucstomer List</h5>
                        </div>
                        @if (Helper::hasRight('customer.create'))
    ...
    @include('backend.pages.customer.modal')
@endsection
